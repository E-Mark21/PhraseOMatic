...
fun main() {
    ...
    val intsLambda: (Int, Int) -> Int = { x, y -> x * y }
    println("Pass 10, 11 to intsLambda: ${intsLambda(10, 11)}")
    ...
    val poundsToUSTons = getConversionLambda("PoundsToUSTons")

    val kgsToUSTonsLambda = combine(kgsToPoundsLambda, poundsToUSTons)
