...
fun main() {
    ...
    println("mSoppingList original: $mShoppingList")
    ...
    val mRecipeMap = mutableMapOf("Recipe1" to r1, "Recope2" to r2, "Recipe3" to r3)
    println("mRecipeMap original: $mRecipeMap")
    val recipesToAdd = mapOf("Recipe4" to r4, "Recipes5" to r5)
